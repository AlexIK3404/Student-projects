%% Hyper-Chen 5D+FB — FB error vs iteration (TIME-SHIFT IC, with Option B) — x-only coupling
...
title(sprintf('5D+FB FB error vs iteration (WT=%.3f, h=%.4f, Kx=%.1f, tau=%.2f, rho=%.2f, e=%.2f)', ...
    WT, h, Kx, tau_shift, rho, e))
hold off
